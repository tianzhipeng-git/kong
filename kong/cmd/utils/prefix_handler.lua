...
local function gen_trusted_certs_combined_file(
  combined_filepath,
  ...
  for _, path in ipairs(lua_ssl_trusted_certificate_combined) do
...
local function prepare_prefix(kong_config, nginx_custom_template_path)
  ...
  if kong_config.lua_ssl_trusted_certificate_combined
     and #kong_config.lua_ssl_trusted_certificate_combined > 0 then
