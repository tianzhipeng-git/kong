...
for _, strategy in helpers.each_strategy() do
  ...
  describe("lua_ssl_trusted_cert_combined #" .. strategy, function()
    ...
    it("works with multiple entries", function()
      assert(helpers.start_kong({
        database   = strategy,
        nginx_conf = "spec/fixtures/custom_nginx.template",
        lua_ssl_trusted_certificate_combined = "spec/fixtures/kong_clustering_ca.crt,spec/fixtures/kong_clustering.crt",
