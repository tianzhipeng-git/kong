  ...
  describe("validations", function()
    ...
    describe("SSL", function()
      describe("proxy", function()
        ...
        it("accepts several CA certs in lua_ssl_trusted_certificate_combined, setting lua_ssl_trusted_certificate", function()
          local conf, _, errors = conf_loader(nil, {
            lua_ssl_trusted_certificate_combined = "spec/fixtures/kong_spec.crt,spec/fixtures/kong_clustering.crt",
          })
          ...
          assert.matches(".ca_combined", conf.lua_ssl_trusted_certificate)
        end)
        it("expands the `system` property in lua_ssl_trusted_certificate_combined", function()
          ...
          local conf, _, errors = conf_loader(nil, {
            lua_ssl_trusted_certificate_combined = "system",
          })
          assert.is_nil(errors)
          assert.matches(".ca_combined", conf.lua_ssl_trusted_certificate)
        end)
